...
| `/气温排行 [时次]` | `/温度排行`, `/气温榜`, `/温度榜` | 查询全国实况气温排行 Top10 |
| `/最低气温排行 [时次]` | `/最低温排行`, `/最低气温榜`, `/低温排行`, `/低温榜` | 查询全国实况最低气温排行 Top10 |
| `/降水排行 [时次]` | `/降水榜`, `/降水量排行`, `/降水量榜` | 查询全国实况降水排行 Top10 |
| `/风速排行 [时次]` | `/风速榜`, `/风速排行榜` | 查询全国实况风速排行 Top10 |
| `/空气质量 <城市/省份/全国>` | `/AQI`, `/aqi`, `/空气质量指数` | 查询城市/省份/全国空气质量 |
| `/空气质量排行 [最好\|最差]` | `/AQI排行`, `/aqi排行`, `/空气质量排行榜`, `/空气榜` | 查询空气质量排行榜 |
| `/空气质量列表 [省份]` | `/AQI列表`, `/aqi列表`, `/空气质量城市列表` | 查看支持的城市列表（可按省份过滤） |
...
# 实况排行查询
# 格式：/气温排行 [时次] | /最低气温排行 [时次] | /降水排行 [时次] | /风速排行 [时次]
...
# 1. 查询单城市空气质量
/空气质量 北京
# 2. 查询全省空气质量（广东，按 AQI 升序）
/空气质量 广东
# 3. 全国主要城市空气质量概览（按等级分组）
/空气质量 全国
# 4. 空气质量排行（无参时同时输出最好与最差 Top10，最好在前）
/空气质量排行
# 5. 指定方向排行
/空气质量排行 最好
/空气质量排行 最差
